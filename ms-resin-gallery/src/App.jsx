      ...
      <header className="hero">
        ...
        <div className="hero-content">
          ...
          <div className="hero-contact">
            ...
            <span>·</span>
            <a href="https://instagram.com/ms_resin_gallery" target="_blank" rel="noreferrer">
              <svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor" style={{ verticalAlign: 'middle', marginRight: '4px' }}>
